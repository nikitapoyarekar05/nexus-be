...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ListingsController.prototype, "getWishlistedListings", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, common_1.Patch)(':id/wishlist'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('wishlisted')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Boolean]),
    __metadata("design:returntype", void 0)
], ListingsController.prototype, "updateWishlist", null);
exports.ListingsController = ListingsController = __decorate([
    (0, common_1.Controller)('listings'),
    __metadata("design:paramtypes", [listing_service_1.ListingsService])
], ListingsController);
